...
public class EmailService : IEmailService
{
    ...
    public async Task<bool> SendEventPositionAssigned(string to, int eventId, string name, string position, string start, string end)
    {
        ...
        return await SendEmail("EventPositionAssigned", to, "vZDC Events",
            "vZDC Event Position Assigned", template);
    }

    public async Task<bool> SendEventRegistrationSubmitted(string to, int eventId, string name, string start, string end)
    {
        ...
        template = template.Replace("{End}", end);
        template = template.Replace("{Link}", $"https://vzdc.xyz/event/{eventId}");
        return await SendEmail("EventRegistrationSubmitted", to, "vZDC Events",
            "vZDC Event Registration Submitted", template);
    }
    ...
    public async Task<bool> SendEventRegistrationRemoved(string to, int eventId, string name)
    {
        ...
        template = template.Replace("{Name}", name);
        template = template.Replace("{Link}", $"https://vzdc.xyz/event/{eventId}");
        return await SendEmail("EventRegistrationRemoved", to, "vZDC Events",
            "vZDC Event Registration Removed", template);
    }
    ...
    public async Task<bool> SendFeedbackApproved(string to, string position, string callsign, string comments, string staffComments)
    {
        ...
        return await SendEmail("FeedbackApproved", to, "vZDC Management",
            "vZDC New Feedback", template);
    }

    public async Task<bool> SendLoaAccepted(string to, string start, string end, string reason)
    {
        var template = await LoadEmailTemplate("LoaAccepted");
        template = template.Replace("{Start}", start);
        template = template.Replace("{End}", end);
        template = template.Replace("{Reason}", reason);
        return await SendEmail("LoaAccepted", to, "vZDC Management",
            "vZDC LOA Accepted", template);
    }

    public async Task<bool> SendLoaSubmitted(string to, string start, string end, string reason)
    {
        var template = await LoadEmailTemplate("LoaSubmitted");
        template = template.Replace("{Start}", start);
        template = template.Replace("{End}", end);
        template = template.Replace("{Reason}", reason);
        return await SendEmail("LoaSubmitted", to, "vZDC Management",
            "vZDC LOA Submitted", template);
    }
    ...
    public async Task<bool> SendLoaDenied(string to, string reason)
    {
        ...
        template = template.Replace("{Reason}", reason);
        return await SendEmail("LoaDenied", to, "vZDC Management",
            "vZDC LOA Denied", template);
    }

    public async Task<bool> SendLoaEnded(string to)
    {
        var template = await LoadEmailTemplate("LoaEnded");
        return await SendEmail("LoaEnded", to, "vZDC Management",
            "vZDC LOA Ended", template);
    }
    ...
    public async Task<bool> SendNewFeedback(string to, int feedbackId, string position, string callsign, string comments)
    {
        ...
        return await SendEmail("NewFeedback", to, "vZDC Management",
            "vZDC New Feedback", template);
    }

    public async Task<bool> SendNewLoa(string to, int loaId, string name, string start, string end, string reason)
    {
        ...
        return await SendEmail("NewLoa", to, "vZDC Management",
            "vZDC New LOA", template);
    }
    ...
    public async Task<bool> SendNewOts(string to, int otsId, string name, string cid, string recommender, string rating, string facility, string position)
    {
        ...
        return await SendEmail("NewOts", to, "vZDC Management",
            "vZDC New OTS", template);
    }

    public async Task<bool> SendNewStaffingRequest(string to, int staffingRequestId, string name, string email, string affiliation, string start, string end, string description)
    {
        ...
        return await SendEmail("NewStaffingRequest", to, "vZDC Events",
            "vZDC New Staffing Request", template);
    }
    ...
    public async Task<bool> SendNewVisitRequest(string to, int visitRequestId, string name, string cid, string rating, string reason, string requirements)
    {
        ...
        return await SendEmail("NewVisitRequest", to, "vZDC Management",
            "vZDC New Visit Request", template);
    }
    ...
    public async Task<bool> SendOtsAssigned(string to, int otsId, string name, string cid, string rating, string facility, string position)
    {
        ...
        template = template.Replace("{Position}", position);
        template = template.Replace("{Link}", $"https://vzdc.xyz/ots/{otsId}");
        return await SendEmail("OtsAssigned", to, "vZDC Management",
            "vZDC New OTS Assignment", template);
    }

    public async Task<bool> SendStaffingRequestSubmitted(string to, string name, string email, string affiliation, string start, string end, string description)
    {
        ...
        template = template.Replace("{End}", end);
        template = template.Replace("{Description}", description);
        return await SendEmail("StaffingRequestSubmitted", to, "vZDC Events",
            "vZDC Staffing Request Submitted", template);
    }
    ...
    public async Task<bool> SendVisitRequestAccepted(string to)
    {
        ...
        return await SendEmail("VisitRequestAccepted", to, "vZDC Management",
            "vZDC Visit Request Accepted", template);
    }
    ...
    public async Task<bool> SendVisitRequestDenied(string to, string reason)
    {
        ...
        template = template.Replace("{Reason}", reason);
        return await SendEmail("VisitRequestDenied", to, "vZDC Management",
            "vZDC Visit Request Denied", template);
    }
}